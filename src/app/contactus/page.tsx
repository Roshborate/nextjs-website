      ...
      <section className="py-12 bg-white">
        <div className="container px-4 mx-auto">
          ...
          <form 
            ...
            className="max-w-lg mx-auto space-y-4">
            <div>
              <label htmlFor="name" className="block mb-1 text-sm font-bold text-gray-700">Name</label>
              <input
                type="text"
                id="name"
                name="name"
            ...
            <div>
              <label htmlFor="message" className="block mb-1 text-sm font-bold text-gray-700">Message</label>
              <textarea
                id="message"
                name="message"
                rows={4}
