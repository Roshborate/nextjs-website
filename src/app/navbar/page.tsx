...
//   return (
//     <nav className="fixed top-0 left-0 z-50 w-full bg-white shadow-md h-16"> {/* Defined a height of 16 */}
//       <div className="container flex items-center justify-between px-4 py-4 mx-auto h-full"> {/* Adjust to h-full for full height */}
//         {/* Logo */}
//         <Link
//           href="/"
//           className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-blue-500 to-purple-600 font-serif hover:text-gray-900"
...
export default function Navbar() {
  ...
  const handleLinkClick = () => {
    setIsOpen(false); // Close the menu after clicking any link
  };
  ...
  return (
    <nav className="fixed top-0 left-0 z-50 w-full bg-white shadow-md h-16"> {/* Defined a height of 16 */}
      <div className="container flex items-center justify-between px-4 py-4 mx-auto h-full"> {/* Adjust to h-full for full height */}
        ...
        {/* Menu Items */}
        <div
          className={`absolute inset-y-0 right-0 z-40 flex flex-col items-center w-32 h-screen p-4 bg-white transition-transform transform md:relative md:h-auto md:flex-row md:p-0 md:bg-transparent md:w-auto md:transform-none ${
